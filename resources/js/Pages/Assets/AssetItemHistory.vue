        ...
        <div class="space-y-6">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 sm:p-8">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-white">Asset Item History</h1>
                                <p class="text-blue-100 text-sm mt-1">
                                    {{ pageDescription }}
                                </p>
                            </div>
                        </div>
                        <div class="mt-6 sm:mt-0 space-x-3">
                            <Link :href="route('assets.index')"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="w-4 h-4 mr-2">
                                    <path d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 13.293A1 1 0 013 12.586V4z" />
                                </svg>
                                Asset Overview
                            </Link>
                            <Link :href="route('assets.index')"
            ...
            <div class="bg-white shadow-xl rounded-2xl p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Asset Item Details</h2>
            ...
            <div class="bg-white shadow-xl rounded-2xl p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">Asset Context</h2>
            ...
            <div class="bg-white shadow-xl rounded-2xl p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">History Timeline</h2>
                    <div class="flex items-center space-x-2">
                        <span class="text-sm text-gray-500">Total Records:</span>
                        <span class="text-lg font-bold text-blue-600">{{ assetItem?.asset_history?.length || 0 }}</span>
                    </div>
                </div>
...
const props = defineProps({
    ...
    pageTitle: {
        type: String,
        default: 'Asset Item History',
    },
    pageDescription: {
        type: String,
        default: 'View detailed history for this asset item',
    },
});
